...
class NFTData extends Struct({
    ...
    static new(params = {}) {
        ...
        return new NFTData({
            ...
            requireOwnerSignatureToUpgrade: Bool(requireOwnerSignatureToUpgrade ?? false),
        });
    }
    /**
    ...
    static unpack(packed) {
        ...
        const id = UInt32.Unsafe.fromField(Field.fromBits(bits.slice(64 + 32, 64 + 32 + 32)));
...
class CollectionData extends Struct({
    ...
    static new(params) {
        ...
        return new CollectionData({
            ...
            requireCreatorSignatureToUpgradeNFT: Bool(requireCreatorSignatureToUpgradeNFT ?? false),
